      ...
      <div className="container">
        ...
        <section className="talks_2023">
          <div className="talks_container">
            ...
            <SpeakerHero id={t('eriol.id')} image='/speakers/2024/eriol-fox.jpeg' name={t('eriol.name')} talk={t('eriol.talk')} title={t('eriol.talk_title')} jobDescription={t('eriol.job_title')} linkedinUrl={t('eriol.linkedin_url')} twitterUrl={t('eriol.twitter_url')}/>
