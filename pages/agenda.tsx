    ...
    <>
      <div className="container">
        ...
        <div className="timeline">
          ...
          <AgendaCard hour='14:15' isBreak={false} speakerName={s('jason.name')} secondSpeakerName={s('jason.name_2')} talkTitle={s('jason.talk_title')} icon='/icons/microphone.svg' position='right' link={s('jason.id')}/>
          <AgendaCard hour='14:50' isBreak={false} speakerName={s('matteo.name')} talkTitle={s('matteo.talk_title')} icon='/icons/microphone.svg' position='left' link={s('matteo.id')}/>
          <AgendaCard hour='15:25' isBreak={false} speakerName={s('serena.name')} talkTitle={s('serena.talk_title')} icon='/icons/microphone.svg' position='right' link={s('serena.id')}/>
          <AgendaCard hour='15:55' isBreak={true} breakTitle='Coffee break & Open Debate & Giveaway' icon='/icons/coffee.svg' position='left'/>
